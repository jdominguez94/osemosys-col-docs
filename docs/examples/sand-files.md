...
Un archivo **SAND** es el Excel de entrada que usa OSeMOSYS Colombia para simular. En una hoja **Parameters** contiene todos los sets y valores paramétricos del modelo (demanda, tecnologías, combustibles, costos, restricciones, etc.), organizados fila por fila. Es el mismo formato que se usa tanto para importar un escenario a la base de datos (`POST /scenarios/import-excel`) como para simular directamente sin base de datos (ver [Carga de datos Excel/SAND](../user-guide/carga-excel-sand.md)).

## Dónde encontrar archivos SAND

La **carpeta `SAND/` del repositorio** contiene archivos SAND de referencia y de histórico, por ejemplo `SAND_01_04_2025.xlsm`, `SAND_26_08_2025.xlsm`, `SAND_18_11_2025_REF.xlsm` y `SAND_15_12_2025_REF.xlsm`. En la **raíz del repositorio** está `SAND_integrado_PA_MR_20_04.xlsx`, un archivo SAND consolidado.
...
## Las tres políticas de cada archivo
