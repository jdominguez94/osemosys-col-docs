...
Sigue el tutorial [Primera simulación](first-simulation.md) para iniciar sesión, crear un escenario y ver resultados. Consulta [Variables de entorno](environment-variables.md) para personalizar puertos, credenciales y parámetros de ejecución. Y para tareas de desarrollo, como tests y linters, revisa [Contribuir](../contributing.md).
