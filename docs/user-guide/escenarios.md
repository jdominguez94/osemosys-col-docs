...
Un **escenario** es el conjunto de datos de entrada sobre el que se ejecuta una simulación, la demanda proyectada, las tecnologías disponibles, los combustibles, los parámetros de costos y disponibilidad y, opcionalmente, las restricciones definidas por el usuario. Este documento cubre el modo de trabajo principal de la aplicación, en el que los escenarios se almacenan y gestionan en la base de datos.
...
Un escenario en modo base de datos referencia un conjunto de parámetros del modelo energético (equivalentes a las hojas de un archivo SAND/Excel tradicional), como tecnologías, combustibles y recursos, demanda por sector, factores de disponibilidad, costos y límites de capacidad.
...
En la sección de escenarios de la aplicación puedes crear uno nuevo. Generalmente esto implica lo siguiente.
...
!!! tip "Timeslices, simulación convencional o con timeslices"
