...
Un escenario en modo base de datos referencia un conjunto de parámetros del modelo energético (equivalentes a las hojas de un archivo SAND/Excel tradicional): tecnologías, combustibles/recursos, demanda por sector, factores de disponibilidad, costos, límites de capacidad, y — si aplica — la configuración de restricciones definidas por el usuario (UDC).
...
4. Opcionalmente, habilitar restricciones definidas por el usuario — ver [UDC](udc.md).
...
- [UDC](udc.md) para agregar restricciones personalizadas a un escenario.
